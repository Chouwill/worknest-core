    ...
    <div class="container mx-auto px-4">
      <div class="flex items-center justify-between h-24">
        ...
        <div class="flex items-center group">
          <router-link to="/">
            <div
              class="flex items-center space-x-5 transition-transform duration-300 hover:scale-105"
            >
              <div class="relative">
                <div
                  class="absolute inset-0 bg-amber-50/20 rounded-full blur-lg group-hover:bg-amber-50/30 transition-all duration-300"
                ></div>
                <img
